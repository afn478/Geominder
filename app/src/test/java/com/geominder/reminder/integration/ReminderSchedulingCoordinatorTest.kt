...
import com.geominder.reminder.alarm.AlarmScheduleMode
...
class ReminderSchedulingCoordinatorTest {
    ...
    private class FakeExactAlarmScheduler : ExactAlarmScheduler {
        ...
        override fun schedule(reminder: Reminder): AlarmScheduleResult {
            ...
            val plan = com.geominder.reminder.alarm.AlarmPlanner.forReminder(reminder)
                as com.geominder.reminder.alarm.ReminderAlarmPlan.Schedule
