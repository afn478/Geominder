...
object AlarmContract {
    const val ACTION_TIME_REMINDER = "com.geominder.reminder.action.TIME_REMINDER"
    const val ACTION_GATED_CHECK = "com.geominder.reminder.action.GATED_CHECK"
    const val ACTION_SNOOZE = "com.geominder.reminder.action.SNOOZE"

    const val EXTRA_REMINDER_ID = "com.geominder.reminder.extra.REMINDER_ID"
    const val EXTRA_TRIGGER_ID = "com.geominder.reminder.extra.TRIGGER_ID"
    const val EXTRA_DELIVERY_MODE = "com.geominder.reminder.extra.DELIVERY_MODE"
